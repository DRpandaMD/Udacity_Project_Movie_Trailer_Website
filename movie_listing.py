...
movies_list = [toy_story, avatar, the_matrix, ip_man, the_lord_of_the_rings, princess_mononoke, spirited_away]

# makes a call to the fresh_tomatoes module I imported to run this
# its important to note that this will create some html that can be later used to render in a browser :)
